...
- **$I_1$ (Left Branch):** Flows through the left loop containing $R_1$, ammeter $A$, and the battery $\mathcal{E}_1$. Let's assume it flows **counter-clockwise**, coming out of the positive terminal (the longer vertical line) of $\mathcal{E}_1$.
